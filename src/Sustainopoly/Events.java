...
public class Events {
    ...
    public void exchange(Player p) {
        ...
        ImageIcon icon1 = new ImageIcon("src/images/Store.png");
        ...
        ImageIcon icon2 = new ImageIcon("src/images/Store.png");
    ...
    public void task(Player p) {
        ...
        ImageIcon icon = new ImageIcon("src/images/KinningPark.png");
